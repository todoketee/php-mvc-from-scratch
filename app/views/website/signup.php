                ...
                <div class="card-body">
                    <form method="POST" action="">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" class="form-control" name="username" required placeholder="username" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="username" class="form-control" name="email" required placeholder="email" autofocus>
                            </div>
                        </div>

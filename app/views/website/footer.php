...
<footer>
    ...
    <script type="text/javascript" src="<?=ASSETS?>website/js/responsee.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>website/js/jquery.events.touch.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>website/owl-carousel/owl.carousel.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>website/js/template-scripts.js"></script> 
  </body>
</html>
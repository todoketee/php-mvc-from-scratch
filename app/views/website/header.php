...
<html lang="en-US">
  <head>
    ...
    <link rel="stylesheet" href="<?=ASSETS?>website/css/components.css">
    <link rel="stylesheet" href="<?=ASSETS?>website/css/icons.css">
    <link rel="stylesheet" href="<?=ASSETS?>website/css/responsee.css">
    <link rel="stylesheet" href="<?=ASSETS?>website/owl-carousel/owl.carousel.css">
    <link rel="stylesheet" href="<?=ASSETS?>website/owl-carousel/owl.theme.css">
    <link rel="stylesheet" href="<?=ASSETS?>website/css/lightcase.css">
    <!-- CUSTOM STYLE -->      
        ...
        <nav class="background-transparent background-transparent-hightlight full-width sticky">
          <div class="s-12 l-2">
            <a href="index.html" class="logo">
              ...
              <img class="logo-before" src="<?=ASSETS?>website/img/logo-dark.png" alt="">
              <!-- Logo version after sticky nav -->
              <img class="logo-after" src="<?=ASSETS?>website/img/logo-dark.png" alt="">
            </a>
          </div>
          <div class="s-12 l-10">
